...
pub fn help(lang: Lang) {
    ...
    Документация:\n
        публичные модули: https://docs.rs/binartree/1.1.2/booklibrs/\n
    ...
    Меню Книги:\n
    1) Добавить книги (усли книга есть в библиотеке, добавит к кол-ву, иначе создаст новую книгу в библиотеке)\n
    ...
    4) Изменить название, автора, кол-во странциц.\n
    ...
    2) Добавить / Удалить жанр. По-умолчанию жанров нет, так что нужно самому добавлять их. \
     Ограничений нет, так что импользуёте всю свою фантазию :)\n
    ...
    2) Вернцть книгу. Вводятся параметры читателя.\
